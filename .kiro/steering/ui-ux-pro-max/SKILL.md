...
```bash
python3 .kiro/steering/ui-ux-pro-max/scripts/search.py "<query>" --design-system --persist -p "Project Name"
```
...
```bash
python3 .kiro/steering/ui-ux-pro-max/scripts/search.py "<query>" --design-system --persist -p "Project Name" --page "dashboard"
```
...
```bash
python3 .kiro/steering/ui-ux-pro-max/scripts/search.py "<keyword>" --stack react-native
```
...
```bash
python3 .kiro/steering/ui-ux-pro-max/scripts/search.py "list performance navigation" --stack react-native
```
